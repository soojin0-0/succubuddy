...
if (answerId != null) {
    ...
    session.setAttribute("userAnswers", userAnswers);
    response.sendRedirect("sub3-result.jsp");
}
%>

<div class="container">
	<div class="Q">Q6</div>
	<div class="title">생각한 예산은 어느 정도인가요?</div>
<div class="img-container">
    <div class="arrow" onclick="location.href='sub3-Q5.jsp?back=true'" style="cursor: pointer;">
        <img src="images/left_arrow.png">
    </div>
    <div class="image">
        <img src="images/sub3_Q6.png">
    </div>
</div>
	<button onclick="submitAnswer(1)">30,000원 이하</button>
	<button onclick="submitAnswer(2)">40,000 - 80,000원 이하</button>
	<button onclick="submitAnswer(3)">90,000원 이상</button>
</div>

<script>
    function submitAnswer(answerId) {
        // 마지막 답변을 URL에 추가한 후 전체 화면에서 결과 페이지로 이동
        window.top.location.href = "sub3-result.jsp?answer_id=" + answerId;
    }
</script>
