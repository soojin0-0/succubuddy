...
String review_text = "", review_ymd = "", product_id = "", product_name = "", review_user_id = "";
...
try {
    ...
    // review + product 조인해서 리뷰와 상품 이름까지 가져오기
    String sql = "SELECT r.product_id, p.name, r.user_id, r.review_text, r.review_score, " +
             "DATE_FORMAT(r.review_ymd, '%Y.%m.%d') AS review_ymd " +
    ...
    if (rs.next()) {
        ...
        review_ymd = rs.getString("review_ymd");
		review_user_id = rs.getString("user_id");
    }
...
<div class="title">
    ...
    <a href="all_review.jsp?product_id=<%= product_id %>">전체 리뷰</a> >
    <font style="color: #7ab863; font-family: 'GmarketSansTTFMedium';"><%= review_user_id %></font>님의 리뷰
</div>
