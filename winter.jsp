  ...
  <div class="form-row">
	...
	<div class="img-textarea">
	  ...
	  <div id="contentField">
		...
		12~2월로 대부분 다육식물은 활동을 멈추고 '휴면'에 들어감
		성장 정지 → 물과 비료 모두 최소화해야 함
		...
		<table>
		  ...
		  <tr>
		    <td>햇빛</td>
			<td>가능한 한 많은 햇빛 (남향 창가 추천)</td>
		  </tr>
		  <tr>
		    <td>물주기</td>
			<td>매우 적게. 흙이 완전히 말랐을 때 '조금만' 주기 (1달에 1~2회)</td>
		  </tr>
		  <tr>
		    <td>온도관리</td>
			<td>5°C 이하로 떨어지지 않도록 주의. 필요하면 실내 이동</td>
		  </tr>
		  <tr>
		    <td>난방기 주의</td>
			<td>난방기 가까이 두면 과열, 건조로 식물 스트레스 발생. 적당한 거리 유지</td>
		  </tr>
		  <tr>
		    <td>비료</td>
			<td>겨울엔 비료는 절대 금지</td>
		...
		→ TIP
		겨울은 다육을 자연 건조 보존 모드로 돌리는 시기입니다. 너무 많은 물과 열은 오히려 해롭습니다.
	  </div>
