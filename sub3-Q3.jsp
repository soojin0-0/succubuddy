...
if (answerId != null) {
    ...
    session.setAttribute("userAnswers", userAnswers);
    response.sendRedirect("sub3-Q4.jsp");
}
%>

<div class="container">
	<div class="Q">Q3</div>
	<div class="title">집의 온도와 습도가 일정한가요?</div>
<div class="img-container">
    <div class="arrow" onclick="location.href='sub3-Q2.jsp?back=true'" style="cursor: pointer;">
        <img src="images/left_arrow.png">
    </div>
    <div class="image">
        <img src="images/sub3_Q3.png">
    </div>
</div>
...
<script>
    function submitAnswer(answerId) {
        window.location.href = "sub3-Q3.jsp?answer_id=" + answerId;
    }
</script>
</body>
</html>