...
<div class="container">
  <div class="container-title">다육 탐구 생활</div>
  <form id="writeForm" action="sub4_write_process.jsp" method="post" enctype="multipart/form-data">
    <div class="form-wrapper">
      <div class="form-title">글 쓰기</div>
      <div class="form-row">
        <input type="text" name="title" class="form-input" placeholder="제목" required>
