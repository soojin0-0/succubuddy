  ...
  <div class="form-row">
	...
	<div class="img-textarea">
	  ...
	  <div id="contentField">
		...
		6~8월로 고온다습으로 다육식물에게 스트레스가 큰 계절
		일부 품종은 여름 휴면기에 들어가 성장 정지
		...
		<table>
		  ...
		  <tr>
		    <td>햇빛</td>
			<td>직사광선 차단 필수! 반그늘, 차광막 설치 추천. 여름 햇볕은 잎을 태울 수 있음</td>
		  </tr>
		  <tr>
		    <td>물주기</td>
			<td>매우 조심! 아침 일찍 또는 해진 후, 흙이 완전히 말랐을 때 소량 급수 (평소보다 횟수 줄이기)</td>
		  </tr>
		  <tr>
		    <td>통풍</td>
			<td>필수! 선풍기나 자연바람으로 공기 순환 유지해야 곰팡이·부패 예방</td>
		  </tr>
		  <tr>
		    <td>분갈이</td>
			<td>절대 금지! 여름에 분갈이하면 식물이 쇼크를 받아 죽을 수 있음</td>
		  </tr>
		  <tr>
		    <td>비료</td>
			<td>품종 (예: 리톱스, 콘포브룸) → 물주기 최소화하고 건조하게 유지</td>
		  </tr>
		</table>
		→ TIP
		여름은 "키운다"기보다 "지킨다"는 마음으로 관리하세요. 과습, 고온 스트레스를 최대한 줄이는 게 핵심입니다.
	  </div>
