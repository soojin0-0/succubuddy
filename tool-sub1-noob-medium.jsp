...
<body>
	...
	<div class="container">
	  ...
	  <table class="tool2" style="margin-top: 40px; margin-bottom: 20px;">
	  	<tr>
		  <td rowspan="2" style="width: 300px;"><img src="images/pot-medium1.png"></td>
		  <td class="tool-name">화분(4종 중 택 1)</td>
		</tr>
		<tr>
		  <td class="explain">바닥에 배수구가 있어 뿌리 썩음 방지에 효과적입니다. 실내외 모두 사용 가능합니다.<br>
		      기본으로 하얀색 화분이 제공되며 백대리석, 흑대리석, 점박이 화분으로 변경이 가능합니다.
		  </td>
		</tr>
	  </table>
	  ...
	  <table class="pot">
	    <tr>
		  <td><img src="images/pot-medium2.png"></td>
		  <td><img src="images/pot-medium3.png"></td>
		  <td><img src="images/pot-medium4.png"></td>
		</tr>
		<tr>
		  <td class="pot-price">백대리석(+2,000)원</td>
		  <td class="pot-price">흑대리석(+2,000)원</td>
		  <td class="pot-price">점박이(+1,800)원</td>
		</tr>
	  </table>
	</div>
	</center>
