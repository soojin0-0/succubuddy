...
try {
    ...
    String sql = "SELECT inquiry_subject, inquiry_text, DATE_FORMAT(inquiry_ymd, '%Y-%m-%d') AS inquiry_date, product_id FROM inquiry WHERE inquiry_id = ?";
...
<center>
    <form method="post" action="inquiryUpdate.jsp">
        <input type="hidden" name="inquiry_id" value="<%= inquiry_id %>">

        <table class="title">
            <tr>
                <td>문의</td>
                <td><font style="color: #f4a900;"><%= product_name %></font> 상품에 대한 문의 수정입니다.</td>
                <td></td>
            </tr>
        </table>
        ...
        <div class="container">
            <div class="detail1">
                <table>
                    <tr>
                        <td><input type="text" name="inquiry_subject" value="<%= inquiry_subject %>" required></td>
                        <td><%= inquiry_ymd %></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="detail2">
                <textarea name="inquiry_text" style="width:100%; height:100%; font-size:28px;" required><%= inquiry_text %></textarea>
            </div>
            ...
            <div class="detail3">
                <table>
                    <tr>
                        <td>비밀번호</td>
                        <td><input type="password" name="inquiry_pswd" required></td>
                    </tr>
                </table>
            </div>
        </div>
