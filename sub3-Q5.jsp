...
if (answerId != null) {
    ...
    session.setAttribute("userAnswers", userAnswers);
    response.sendRedirect("sub3-Q6.jsp");
}
%>

<div class="container">
	<div class="Q">Q5</div>
	<div class="title">반려동물을 키우시나요?</div>
	<div class="explain">강아지, 고양이처럼 다육에 직접<br>
	접촉할 수 있는 동물을 키우는 경우</div>
<div class="img-container">
    <div class="arrow" onclick="location.href='sub3-Q4.jsp?back=true'" style="cursor: pointer;">
        <img src="images/left_arrow.png">
    </div>
    <div class="image">
        <img src="images/sub3_Q5.png">
    </div>
</div>
	<button onclick="submitAnswer(1)">예, 그렇습니다</button>
	<button onclick="submitAnswer(2)">아니요, 그렇지 않습니다</button>
</div>

<script>
    function submitAnswer(answerId) {
        window.location.href = "sub3-Q5.jsp?answer_id=" + answerId;
    }
</script>
</body>
</html>