  ...
  <div class="form-row">
	...
	<div class="img-textarea">
	  ...
	  <div id="contentField">
		...
		3~5월로 겨울잠(휴면)에서 깨어나 활동을 시작하는 계절
		새순이 돋고, 성장 준비
		...
		<table>
		  ...
		  <tr>
		    <td>햇빛</td>
			<td>천천히 일조량을 늘려야 함. 갑자기 강한 햇빛은 화상을 입힐 수 있으니 조심!</td>
		  </tr>
		  <tr>
		    <td>물주기</td>
			<td>겨울보다 조금 더 자주. 흙이 완전히 마른 후 듬뿍 주기 시작 (23주에 1회 → 12주에 1회)</td>
		  </tr>
		  <tr>
		    <td>분갈이</td>
			<td>가장 좋은 시기! 오래된 흙이나 꽉 찬 화분은 교체하세요.</td>
		  </tr>
		  <tr>
		    <td>비료</td>
			<td>완효성 비료나 약한 액체비료를 소량 시도 가능 (너무 과하면 안 됨)</td>
		  </tr>
		  <tr>
		    <td>병해충 예방</td>
			<td>겨울에 쌓인 먼지, 벌레를 청소하고 새살림 준비</td>
		  </tr>
		</table>
		→ TIP
		봄에는 성장 에너지가 왕성하니, 적절한 햇빛과 급수로 건강한 새순을 키우는 데 집중해야 합니다.
	  </div>
