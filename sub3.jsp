...
<div class="iframe-container">
    <iframe id="questionFrame" src="sub3-main.jsp" frameborder="0"></iframe>
</div>

<script>
    function resizeIframe() {
        var iframe = document.getElementById("questionFrame");
        iframe.style.width = "1620px";
    ...
    window.onload = resizeIframe;
	 ...
	 // 설문 시작 시, 첫 번째 질문 로드
        function startQuestionnaire() {
            document.getElementById("questionFrame").src = "sub3-Q1.jsp";
        }

        // 다음 질문으로 이동 (iframe 내에서 이동)
        function goToNextQuestion(nextPage) {
            document.getElementById("questionFrame").src = nextPage;
        }

        // 결과 페이지로 이동 (iframe 제거 후 전체 화면 전환)
        function goToResultPage() {
            window.location.href = "sub3-result.jsp";
        }
</script>
